...
class AgendasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create agenda" do
    assert_difference('Agenda.count') do
      post agendas_url, params: { agenda: { end_at: @agenda.end_at, start_at: @agenda.start_at, title: @agenda.title } }
    end
  ...
  test "should update agenda" do
    patch agenda_url(@agenda), params: { agenda: { end_at: @agenda.end_at, start_at: @agenda.start_at, title: @agenda.title } }
